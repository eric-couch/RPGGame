...
namespace RPGGame.Controllers
{
    public class HeroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Health,Level,Experience,Alive")] Hero hero)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Health,Level,Experience,Alive")] Hero hero)
        {
            if (id != hero.ID)
            {
                return NotFound();
